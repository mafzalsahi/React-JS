...
import {Button,Input, Logo,SelectBtn,authService} from './index'
    ...
    return(
        <div className="flex items-center justify-center w-full">
            <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black-10`}>
                ...
                <Link to="/signup" className="font-meduim text-primary transition-all duration-200 hover:underline">
                Sign Up
                </Link>
                </p>
